...
(defconst wisent-php--parse-table
  (progn
	...
	((class_name T_PAAMAYIM_NEKUDOTAYIM T_CLASS)
	 (concat $1 $2 $3))))
     '(top_statement_start assignment_list_elements case_list_brace_block catch_list_name_paren_block class_statement_list const_list_paren_block encaps_var_offset_brack_block expr expr_brace_block expr_paren_block for_exprs_paren_block foreach_paren_block inline_use_declarations_brace_block inner_statement_list_brace_block isset_variables lexical_var_list non_empty_argument_list optional_expr parameter_list top_statement_list trait_adaptations_brace_block unset_variables use_declarations_brace_block variable_brace_block class_const_list const_list constant encaps_var inner_statement_list property simple_variable static_var top_statement)))
  "Parser table.")
